        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det): # reversed反转列表顺序
                    ...
                    if(conf > 0.9):
                        return ((tlbr[0] + tlbr[2]) / 2 / wid, (tlbr[1] + tlbr[3]) / 2 / hei)
...
def detect():
    return run(weights=ROOT / 'best.pt', source=0, data=ROOT / '0515.yaml', conf_thres=0.7, device='0', view_img=True, vid_stride=90)
