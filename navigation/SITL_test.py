...
from mission import clear_waypoint,upload_mission_till_completed, execute_bomb_course, loiter_at_present, loiter, wp_circle_course, wp_straight_course
...
#执行投弹航线
execute_bomb_course(the_connection, home_position, position_now(the_connection), wp5, precision=5, line_course=200, direction=1, radius=150)
