...
wp_list = wp_straight_course(wp_line1, 5)
wp_list.extend(wp_circle_course(wp_circle1, 10, 180, 1))
wp_list.extend(wp_straight_course(wp_line2, 5))
wp_list.extend(wp_circle_course(wp_circle2, 10, 180, 1))
